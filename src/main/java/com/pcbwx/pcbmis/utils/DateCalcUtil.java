...
//	private static final Logger logger = Logger.getLogger(DateCalcUtil.class);
	...
	public static void main(String[] args) {
		Date now = DateTimeUtil.truncateDateTime(new Date());
		System.out.println(DateCalcUtil.subTime(now, Calendar.DAY_OF_YEAR, 1));
		
		Calendar cal = Calendar.getInstance();
        cal.setTime(DateTimeUtil.dateTimeStr2date("2016-07-18 00:00:00"));
