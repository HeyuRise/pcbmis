...
public class DataUtil {
	...
	public static Object fatherToChild(Object father, Class<?> childClass) {
		...
		for (int i = 0; i < ff.length; i++) {
			...
			try {
				// 方法getDeleteDate
				String upperFieldName = StringUtil.toUpperFirst(field.getName());
	...
	public static <T1, T2> Map<T1, T2> list2map(List<T2> list, Class<?> srcClazz, String keyName)
	...
	public static <T1, T2> Map<T1, List<T2>> list2mapList(List<T2> list, Class<?> srcClazz, String keyName)
			throws NoSuchMethodException, SecurityException {
	...
	public static <T1, T2> List<T1> mapKey2list(Map<T1, T2> map) throws NoSuchMethodException,
			SecurityException {
	...
	public static <T1, T2> List<T2> mapValue2list(Map<T1, T2> map) throws NoSuchMethodException,
			SecurityException {
	...
	public static <T1, T2> List<T1> fetchField2list(List<T2> list, Class<?> srcClazz, String keyName)
			throws NoSuchMethodException, SecurityException {
	...
	public static <T1, T2> List<T1> fetchField2listNoDuplicate(List<T2> list, Class<?> srcClazz,
			String keyName) throws NoSuchMethodException, SecurityException {
		if (list == null || list.isEmpty()) {
	...
	public static Map<String, Object> fetchField2list(Object obj) throws NoSuchMethodException,
			SecurityException {
