 ...
 *
 */
public enum CheckOptionEnum{
	
	FACTORY("factory", "生产厂家"),
	BOARD_PREVENT_SMT("board_prevent_smt", "阻焊膜印刷面"),
	PREVENT_SMT_COLOR("prevent_smt_color", "阻焊膜颜色"),
	BOARD_CHARACTER("board_character", "标记印刷面"),
	CHARACTER_COLOR("character_color", "标记颜色"),
	LOGO("logo", "标记logo"),
	BATCH_NUMBER("batch_number", "标记批次号"),
	SURFACE_PROCESS("surface_process", "表面处理"),
	VIAHOLEPROCESS("viaHoleProcess", "过孔处理"),
	// 模板字段
	BURRS("burrs", "毛刺"),
	GAP("gap", "缺口"),
	...
	private CheckOptionEnum(String code, String desc) {
		this.code = code;
		this.desc = desc;
	}
